...
export const AUCTION_CSS = `<style>
  ...
  .ac-date{position:absolute;left:12px;bottom:8px;z-index:2;display:inline-flex;align-items:center;gap:4px;color:#fff;font-size:var(--fs-label,12px);font-weight:600}
